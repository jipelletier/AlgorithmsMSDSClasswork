...
# Since  𝑥,𝑦
#   differe only in their  𝑖𝑡ℎ
#   bits, we can assume  𝑥𝑖=0
#   and  𝑦𝑖=1
#  . Therefore,  𝐻𝑥+𝐻𝑖=𝐻𝑦
#   wherein,  +
#   refers to entrywise XOR and  𝐻𝑖
#   is the  𝑖𝑡ℎ
#   column of  𝐻. Thus,  𝐻𝑥=𝐻𝑦 if and only if  𝐻𝑖 has all zeros. This happens with probability  12𝑚
...
# Let us assume that  𝑥
#   and  𝑦
#   differ in  𝑘
#   out of  𝑛
#   positions. We know that  𝐻𝑥=𝐻𝑦
#   if and only if  𝐻𝑥+𝐻𝑦=0
#   where  +
#   is XOR and  0
#   is the vector of all zeros. But  𝐻𝑥+𝐻𝑦=𝐻(𝑥+𝑦)
#   since AND distributes over XOR.
# 
# Whenever  𝑥
#   and  𝑦
#   agree in the  𝑖𝑡ℎ
#   entries, we have the  𝑖𝑡ℎ
#   entry of  (𝑥+𝑦)
#   is zero. Therefore,  𝐻(𝑥+𝑦)
#   is just the XOR sum of  𝑘
#   columns of  𝐻
#   corresponding to positions where  𝑥
#   and  𝑦
#   differ.
# 
# Thus, one of the columns must equal the sum of the remaining  𝑘−1
#   columns. Let us fix these  𝑘−1
#   columns as given and the last column as randomly chosen. The probability that each of the  𝑚
#   entries of the last column matches the sum of the first  𝑘−1
#   column is  12𝑚
#  .
